#!/bin/bash
# Unduh foto produk UROVO (PNG transparan asli) ke folder img/
# Jalankan: bash get-images.sh  lalu commit folder img/ ke GitHub
mkdir -p img
...
echo ""
echo "Selesai! Ganti file di img/ dengan foto Anda sendiri kapan saja — halaman otomatis pakai img/ lebih dulu."
